...
class EvCmdType(IntEnum):
    ...
    AC_WORLD_X = auto()
    AC_WORLD_Z = auto()
    AC_HERO_MATCH_X = auto()
    AC_HERO_MATCH_Z = auto()
    _SET_POS_HERO_MATCH_X = auto()
    _SET_POS_HERO_MATCH_Z = auto()
    AC_UP_CENTER = auto()
    AC_DOWN_CENTER = auto()
    AC_LEFT_CENTER = auto()
    AC_RIGHT_CENTER = auto()
    AC_DIR_UP_CENTER = auto()
    AC_DIR_DOWN_CENTER = auto()
    AC_DIR_LEFT_CENTER = auto()
    AC_DIR_RIGHT_CENTER = auto()
    AC_VANISH_ON = auto()
    AC_VANISH_OFF = auto()
    AC_DIR_PAUSE_ON = auto()
    AC_DIR_PAUSE_OFF = auto()
    AC_ANM_PAUSE_ON = auto()
    AC_ANM_PAUSE_OFF = auto()
    AC_PC_BOW = auto()
    AC_HIDE_PULLOFF = auto()
    AC_HERO_BANZAI = auto()
    AC_MARK_SAISEN = auto()
    AC_HERO_BANZAI_UKE = auto()
    ACMD_NOT = auto()
    _GET_LANGUAGE = auto()
    ...
    AC_INVISIBLE_ON = auto()
    AC_INVISIBLE_OFF = auto()
